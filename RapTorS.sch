...
~MCLR
Text GLabel 9800 -2150 2    50   BiDi ~ 0
ISPDAT
...
F 2 "Capacitors_SMD:C_0805" H 2788 3450 50  0001 C CNN
...
U 1 1 5B68889A
P 8300 -2450
F 0 "#PWR02" H 8300 -2600 50  0001 C CNN
F 1 "+3V3" H 8315 -2277 50  0000 C CNN
...
F 1 "+3V3" H 6215 -1977 50  0000 C CNN
...
U 1 1 5B6928F4
P 8300 -650
F 0 "#PWR011" H 8300 -900 50  0001 C CNN
F 1 "GND" H 8305 -823 50  0000 C CNN
...
MOSI
Text GLabel 6250 -950 0    50   Output ~ 0
LED
Wire Wire Line
	6250 -950 6300 -950
Wire Wire Line
...
U 1 1 5B5A1512
P 8300 -1750
F 0 "U1" H 10050 -1100 50  0000 C CNN
F 1 "PIC16LF1454-I_ML" H 9700 -1200 50  0000 C CNN
F 2 "Housings_DFN_QFN:QFN-16-1EP_4x4mm_Pitch0.65mm" H 8300 -1750 50  0001 C CNN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/41639A.pdf" H 8300 -1750 50  0001 C CNN
	1    8300 -1750
	1    0    0    -1  
$EndComp
...
$EndComp
$Comp
L EFM32HG308F64G-A-QFN24:EFM32HG308F64G-A-QFN24 IC?
U 1 1 5B969C21
P 7050 2650
F 0 "IC?" H 8400 3350 50  0000 L CNN
F 1 "EFM32HG308F64G-A-QFN24" H 7300 2800 50  0000 L CNN
F 2 "QFN65P500X500X90-25N" H 8500 3250 50  0001 L CNN
